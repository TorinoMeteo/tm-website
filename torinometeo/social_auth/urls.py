...
urlpatterns = [
    ...
    url(r'^password_reset/$',
        ...
        {'template_name': 'social_auth/password_reset_form.html'},
        name='password_reset'),
    url(r'^password_reset/done/$',
        views.PasswordResetDoneView.as_view(),
        {'template_name': 'social_auth/password_reset_done.html'},
        name='password_reset_done'),
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
        views.PasswordResetConfirmView.as_view(),
        {'template_name': 'social_auth/password_reset_confirm.html'},
        name='password_reset_confirm'),
    url(r'^reset/done/$',
        views.PasswordResetCompleteView.as_view(),
        {'template_name': 'social_auth/password_reset_complete.html'},
